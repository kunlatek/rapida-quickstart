<!-- src/routes/profile/company/new/+page.svelte -->
<script>
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const response = await profileService.createCompanyProfile(profileData);
      success = 'Perfil criado com sucesso!';
      toastStore.success('Perfil de empresa criado com sucesso!');
...
<svelte:head>
  <title>Criar Perfil de Empresa - Rapida Quickstart</title>
</svelte:head>

<div class="max-w-4xl mx-auto pb-20">
  <Card>
    <Heading tag="h1" class="text-2xl font-bold mb-6">Criar Perfil de Empresa</Heading>
    <div class="text-gray-500 dark:text-gray-400 mb-6">
      <p>Preencha o formulário abaixo para criar seu perfil de empresa. Os campos marcados com <span class="text-red-500">*</span> são obrigatórios.</p>
    </div>

  ...
  onMount(async () => {
    ...
    try {
      ...
      if (profile.rgIssuanceDate) {
        profile.rgIssuanceDate = new Date(profile.rgIssuanceDate).toISOString().split('T')[0];
      }
...
<div class="max-w-4xl mx-auto pb-20">
  <Card>
    <Heading tag="h1" class="text-2xl font-bold mb-6">Editar Perfil de Pessoa</Heading>
    ...
    {:else if profile}
      <div class="text-gray-500 dark:text-gray-400 mb-6">
        <p>Edite as informações do seu perfil de pessoa. Os campos marcados com <span class="text-red-500">*</span> são obrigatórios.</p>
      </div>

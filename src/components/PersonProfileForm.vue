    ...
    <template>
      <a-form
        ref="personProfileFormRef"
        name="dynamic_form_person_profile"
        autocomplete="off"
        layout="vertical"
        :model="personProfileDynamicValidateForm"
        :rules="personProfileRules"
        @validate="handlePersonProfileValidate"
        @finish="onFinish"
      ...
      >
        <a-input
          ...
          v-model:value="personProfileDynamicValidateForm.userId"
          id="input-user_id"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.personName"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.personNickname"
  ...
  >
    <a-select
        ref="select"
        v-model:value="personProfileDynamicValidateForm.gender"
        id="select-gender"
        placeholder="Gênero"
      ...
      >
        <a-date-picker class="full-width"
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.birthday"
          id="input-birthday"
      ...
      >
        <QuillEditor
          ...
          v-model:content="personProfileDynamicValidateForm.personDescription"
          id="input-person_description" 
  ...
  >
    <a-select
        ref="select"
        v-model:value="personProfileDynamicValidateForm.maritalStatus"
        id="select-marital_status"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.motherName"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.fatherName"
    ...
    >
      <a-select
        v-model:value="personProfileDynamicValidateForm.tagId"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.cpf"
          id="input-cpf"
      ...
      >
        ...
        >
          <a-button
            :disabled="permission === 'read'"
            @click="$refs.cpfFileFileInput.click()"
          >
            Upload
          </a-button>
          <input
            type="file"
            ref="cpfFileFileInput"
            style="display: none"
            @change="(e) => handleFileChange(e, 'cpfFile')"
          /><br /><br />
          <a-list
            size="small" bordered
            v-if="personProfileDynamicValidateForm.cpfFile?.length > 0"
            item-layout="horizontal"
            :data-source="personProfileDynamicValidateForm.cpfFile"
          >
            <template #renderItem="{ item }">
              <a-list-item>
                <template #actions>
                  <a key="remove-file"
                    @click="removeFile(item, 'cpfFile')"
                  >Remover</a>
                </template>
                <a-list-item-meta>
                  <template #title>
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.rg"
          id="input-rg"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.rgIssuingAuthority"
          id="input-rg_issuing_authority"
      ...
      >
        <a-date-picker class="full-width"
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.rgIssuanceDate"
          id="input-rg_issuance_date"
          valueFormat="YYYY-MM-DD"
  ...
  >
    <a-select
        ref="select"
        v-model:value="personProfileDynamicValidateForm.rgState"
        id="select-rg_state"
      ...
      >
        ...
        >
          <a-button
            :disabled="permission === 'read'"
            @click="$refs.rgFileFileInput.click()"
          >
            Upload
          </a-button>
          <input
            ...
            ref="rgFileFileInput"
            style="display: none"
            @change="(e) => handleFileChange(e, 'rgFile')"
          /><br /><br />
          <a-list
            size="small" bordered
            v-if="personProfileDynamicValidateForm.rgFile?.length > 0"
            item-layout="horizontal"
            :data-source="personProfileDynamicValidateForm.rgFile"
          >
            <template #renderItem="{ item }">
              <a-list-item>
                <template #actions>
                  <a key="remove-file"
                    @click="removeFile(item, 'rgFile')"
                  >Remover</a>
                </template>
                <a-list-item-meta>
                  <template #title>
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.passport"
          id="input-passport"
      ...
      >
        <a-date-picker class="full-width"
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.passportIssuanceDate"
          id="input-passport_issuance_date"
          valueFormat="YYYY-MM-DD"
      ...
      >
        <a-date-picker class="full-width"
          ...
          id="input-passport_expiration_date"
          valueFormat="YYYY-MM-DD"
      ...
      >
        ...
        >
          <a-button
            :disabled="permission === 'read'"
            @click="$refs.passportFileFileInput.click()"
          >
            Upload
          </a-button>
          <input
            type="file"
            ref="passportFileFileInput"
            style="display: none"
            @change="(e) => handleFileChange(e, 'passportFile')"
          /><br /><br />
          <a-list
            size="small" bordered
            v-if="personProfileDynamicValidateForm.passportFile?.length > 0"
            item-layout="horizontal"
            :data-source="personProfileDynamicValidateForm.passportFile"
          >
            <template #renderItem="{ item }">
              <a-list-item>
                <template #actions>
                  <a key="remove-file"
                    @click="removeFile(item, 'passportFile')"
                  >Remover</a>
                </template>
                <a-list-item-meta>
                  <template #title>
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.phoneNumberOne"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.phoneNumberTwo"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.emailOne"
          id="input-email_one"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.emailTwo"
          id="input-email_two"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.linkedin"
          id="input-linkedin"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.instagram"
          id="input-instagram"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.facebook"
          id="input-facebook"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.x"
          id="input-x"
  ...
  >
    <a-select
        ref="select"
        v-model:value="personProfileDynamicValidateForm.addressOneType"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressOneStreet"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressOneNumber"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressOneComplement"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressOneCity"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressOneState"
  ...
  >
    <a-select
        ref="select"
        v-model:value="personProfileDynamicValidateForm.addressTwoType"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressTwoStreet"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressTwoNumber"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressTwoComplement"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressTwoCity"
      ...
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personProfileDynamicValidateForm.addressTwoState"
      ...
      <a-space
        v-for="(profession, professionsIndex) in personProfileDynamicValidateForm.professions"
        :key="professionsIndex"
      ...
      >
        <a-card class='card'>
          <div>
    <a-form-item
      :label="'Ocupação ' + (professionsIndex + 1)"
      :name="`profession.jobId_${professionsIndex}`"
      
    >
      <a-select
        v-model:value="profession.jobId"
        id="autocomplete-job_id"
        show-search
        ...
        :options="jobIdOptions.data"
        :disabled="permission === 'read'"
        @search="onJobIdSearchDebounced"
        @change="onJobIdChange"
      ></a-select>
    </a-form-item>
      <a-form-item
        label="Mês de entrada no trabalho"
        name="profession.jobStartDateMonth"
        
      >
        <a-input-number
          :disabled="permission === 'read'"
          v-model:value="profession.jobStartDateMonth"
      ...
      <a-form-item
        label="Ano de entrada no trabalho"
        name="profession.jobStartDateYear"
        
      >
        <a-input-number
          :disabled="permission === 'read'"
          v-model:value="profession.jobStartDateYear"
      ...
      <a-form-item
        label="Ano de saída do trabalho"
        name="profession.jobFinishDateYear"
        
      >
        <a-input-number
          :disabled="permission === 'read'"
          v-model:value="profession.jobFinishDateYear"
      ...
      <a-form-item
        label="Mês de saída do trabalho"
        name="profession.jobFinishDateMonth"
        
      >
        <a-input-number
          :disabled="permission === 'read'"
          v-model:value="profession.jobFinishDateMonth"
      ...
      <a-form-item
        ...
        name="profession.jobDescription"
        
      >
        <QuillEditor
          :enable="permission !== 'read'"
          ref="jobDescriptionRef"
          v-model:content="profession.jobDescription"
  ...
  >
    <a-select
        ref="select"
        v-model:value="personProfileDynamicValidateForm.personEducation"
        id="select-person_education"
        placeholder="Escolaridade"
        @change="[checkPersonEducationsCondition(),]"
      ...
      <a-space
        v-for="(personEducation, personEducationsIndex) in personProfileDynamicValidateForm.personEducations"
        :key="personEducationsIndex"
        style="display: flex; margin-bottom: 8px"
        align="baseline"
      >
        <a-card class='card'>
      ...
      <a-form-item
        label="Curso"
        name="personEducation.personEducationCourse"
        
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personEducation.personEducationCourse"
      ...
      <a-form-item
        label="Instituição"
        name="personEducation.personEducationInstitution"
        
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personEducation.personEducationInstitution"
      ...
      <a-form-item
        :label="'Data de início ' + (personEducationsIndex + 1)"
        :name="`personEducation.personEducationStartDate_${personEducationsIndex}`"
        
      >
        <a-date-picker class="full-width"
          :disabled="permission === 'read'"
          v-model:value="personEducation.personEducationStartDate"
          id="input-person_education_start_date"
          valueFormat="YYYY-MM-DD"
      ...
      <a-form-item
        :label="'Data de término ' + (personEducationsIndex + 1)"
        :name="`personEducation.personEducationFinishDate_${personEducationsIndex}`"
        
      >
        <a-date-picker class="full-width"
          :disabled="permission === 'read'"
          v-model:value="personEducation.personEducationFinishDate"
          id="input-person_education_finish_date"
          valueFormat="YYYY-MM-DD"
      ...
      <a-form-item
        ...
        name="personEducation.personEducationDescription"
        
      >
        <QuillEditor
          :enable="permission !== 'read'"
          ref="personEducationDescriptionRef"
          v-model:content="personEducation.personEducationDescription"
          id="input-person_education_description" 
          contentType="html"  theme="snow" />
      </a-form-item>
      <div
      >
        <a-form-item
          label="Certificado"
          name="personEducation.personEducationCertificateFile"
        >
          <a-button
            :disabled="permission === 'read'"
          ...
          <input
            type="file"
            ref="personEducationCertificateFileFileInput"
            style="display: none"
            @change="(e) => handleFileChange(e, 'personEducationCertificateFile')"
          /><br /><br />
          <a-list
            size="small" bordered
          ...
          >
            <template #renderItem="{ item }">
              <a-list-item>
                <template #actions>
                  <a key="remove-file"
                    @click="removeFile(item, 'personEducationCertificateFile')"
                  >Remover</a>
                </template>
                <a-list-item-meta>
                  <template #title>
          ...
          <a-button
            v-if="permission == 'edit'"
            type="primary" danger block
            id="button-remove_person_educations"
      ...
      <a-form-item
        v-if="personEducationsCondition"
      >
        <a-button
          v-if="permission == 'edit'"
          type="dashed" block
          id="button-add_person_educations"
      ...
      <a-space
        v-for="(personCourse, personCoursesIndex) in personProfileDynamicValidateForm.personCourses"
        :key="personCoursesIndex"
        style="display: flex; margin-bottom: 8px"
        align="baseline"
      >
        <a-card class='card'>
      ...
      <a-form-item
        label="Curso"
        name="personCourse.personCourseName"
        
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personCourse.personCourseName"
      ...
      <a-form-item
        label="Instituição"
        name="personCourse.personCourseInstitution"
        
      >
        <a-input
          :disabled="permission === 'read'"
          v-model:value="personCourse.personCourseInstitution"
      ...
      <a-form-item
        :label="'Data de início ' + (personCoursesIndex + 1)"
        :name="`personCourse.personCourseStartDate_${personCoursesIndex}`"
        
      >
        <a-date-picker class="full-width"
          :disabled="permission === 'read'"
          v-model:value="personCourse.personCourseStartDate"
          id="input-person_course_start_date"
          valueFormat="YYYY-MM-DD"
      ...
      <a-form-item
        :label="'Data de término ' + (personCoursesIndex + 1)"
        :name="`personCourse.personCourseFinishDate_${personCoursesIndex}`"
        
      >
        <a-date-picker class="full-width"
          :disabled="permission === 'read'"
          v-model:value="personCourse.personCourseFinishDate"
          id="input-person_course_finish_date"
          valueFormat="YYYY-MM-DD"
      ...
      <a-form-item
        label="Descrição do curso"
        name="personCourse.personCourseDescription"
        
      >
        <QuillEditor
          :enable="permission !== 'read'"
          ref="personCourseDescriptionRef"
          v-model:content="personCourse.personCourseDescription"
          id="input-person_course_description" 
          contentType="html"  theme="snow" />
      </a-form-item>
      <div
      >
        <a-form-item
          label="Certificado"
          name="personCourse.personCourseCertificateFile"
        >
          <a-button
            :disabled="permission === 'read'"
          ...
          <input
            type="file"
            ref="personCourseCertificateFileFileInput"
            style="display: none"
            @change="(e) => handleFileChange(e, 'personCourseCertificateFile')"
          /><br /><br />
          <a-list
            size="small" bordered
          ...
          >
            <template #renderItem="{ item }">
              <a-list-item>
                <template #actions>
                  <a key="remove-file"
                    @click="removeFile(item, 'personCourseCertificateFile')"
                  >Remover</a>
                </template>
                <a-list-item-meta>
                  <template #title>
          ...
          <a-button
            v-if="permission == 'edit'"
            type="primary" danger block
            id="button-remove_person_courses"
  ...
  >
    <a-select
        ref="select"
        v-model:value="personProfileDynamicValidateForm.personLanguages"
        id="select-person_languages"
        placeholder="Idiomas"
        
        
        
        
        :options="personLanguagesOptions"
        :disabled="permission === 'read'"
      ></a-select>
    </a-form-item>
        </a-tab-pane>
  ...
  >
    <a-select
      ...
      <a-space
        v-for="(relatedFile, relatedFilesIndex) in personProfileDynamicValidateForm.relatedFiles"
      ...
      >
        ...
        >
          ...
          <a-list
            size="small" bordered
            v-if="personProfileDynamicValidateForm.relatedFilesFiles?.length > 0"
            item-layout="horizontal"
            :data-source="personProfileDynamicValidateForm.relatedFilesFiles"
          >
            <template #renderItem="{ item }">
              <a-list-item>
                <template #actions>
    ...
    <style>
      ...
      <script lang="ts" setup>
        ...
        onMounted(async () => {
          ...
          for (const attr in data) { if (attr in personProfileDynamicValidateForm) personProfileDynamicValidateForm[attr] = data[attr];

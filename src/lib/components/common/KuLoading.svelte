<script>
    ...
    export let fullScreen = false; // Whether to display as full screen overlay
    export let color = "blue"; // Primary color for the spinner
    export let showBackground = false; // Whether to show a semi-transparent background
    ...
    $: containerClasses = fullScreen 
      ? "fixed inset-0 flex items-center justify-center z-50" + (showBackground ? " bg-gray-900/50 dark:bg-gray-900/80" : "")
